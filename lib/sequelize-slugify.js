...
SequelizeSlugify.prototype.slugifyModel = function (Model, slugOptions) {
    ...
    var handleSlugify = function (instance, options, forceUpdate) {
        ...
        if (!slugValue || forceUpdate || (slugOptions.overwrite && changed)) {
    ...
    // Add method to be called manually
    Model.prototype.updateSlug = function(){
        return handleSlugify(this, null, true);
    };
